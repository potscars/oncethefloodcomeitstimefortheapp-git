...
/// Zul: Carry array for bottomGradient, replacement for unsafe property
@property (strong, nonatomic) NSArray *bottomGradientBundled;
...
/// The custom line's y-value translated into the coordinate system
@property (assign, nonatomic) CGFloat customLineYCoordinate;

/// Specify how much line needed, with carrying data
@property (strong, nonatomic) NSArray *customLineDataToPass;
