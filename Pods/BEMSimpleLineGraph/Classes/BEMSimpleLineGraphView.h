...
/// The custom line
@property (strong, nonatomic) NSArray *requiredCustomLineData;
...
/// Zul: Same as above but with carry in Array.
@property (strong, nonatomic) NSArray *gradientBottomBundled;
