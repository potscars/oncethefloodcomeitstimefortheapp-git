...
- (void)drawLine {
    ...
    line.bottomGradientBundled = self.gradientBottomBundled;
    ...
    line.customLineDataToPass = self.requiredCustomLineData;
...
- (void)drawYAxis {
    ...
    if (self.autoScaleYAxis) {
        ...
        NSLog(@"[BEMSimpleLineGraph] Minimum value is %d",minimumValue);
        NSLog(@"[BEMSimpleLineGraph] Maximum value is %d",maximumValue);
...
- (NSArray *)calculationDataPoints {
    ...
    NSLog(@"[BEMSimpleLineGraph] Datapoints is %d",dataPoints);
